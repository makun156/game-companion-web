        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="游戏分类" prop="categoryId">
              <el-select v-model="queryParams.categoryId" placeholder="请选择游戏分类" clearable @focus="getCategoryList">
...
const categoryList = ref<GameCategoryVO[]>([]);
...
const data = reactive<PageData<GamesForm, GamesQuery>>({
  ...
  rules: {
    ...
    categoryId: [{ required: true, message: '游戏分类不能为空', trigger: 'change' }],
...
const getCategoryList = async () => {
  const res = await listGameCategory();
